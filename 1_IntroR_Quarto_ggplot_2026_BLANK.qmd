...
THIS TUTORIAL COMPLETED BY: (Nat Bonning)
...
fivethirtyeight::
  #how to look thru library of items in 5 38
...
sweetness
#sugar % prob not best predictor of win
```
...
price_fruity <- ggplot(candy_rankings) +
...
```{r}
sweet_price <- ggplot(candy_rankings) +
